...
public class functions {
    ...
    public static Mat limiarizaçãoY(int m, Mat img) {
        ...
        Mat YIQ = new Mat(img.rows(), img.cols(), CvType.CV_32FC3); //Matriz YIQ.           
        ...
        resultado = converterYIQRGB(resultado);
        return resultado;
    }
     */
    /*
            ...
            for (int j = 0; j < img.cols(); j++) {
               ...
               // System.out.println("Mediana: " + Mediana + " Tam Kernel: " + tamKernel);
                ...
                for (int a = 0; a < Tamk; a++) {
                    ...
                    Final[0] = KernelOrdenadoR.get(Mediana);//mediana B
                    Final[1] = KernelOrdenadoG.get(Mediana);//mediana G
                    Final[2] = KernelOrdenadoB.get(Mediana);//mediana R
    ...
    public static void FiltroMedia(int Tamk, int matrix[][]) {
        ...
        for (int i = 0; i < linha; i++) {
            for (int j = 0; j < coluna; j++) {
                ...
                MOriginal[i+nAddBordas][j+nAddBordas] = media;  // Atualiza MO para calculo do proximo pixel.
        ...
        //Matriz pós media.
        System.out.println("Matriz MOriginal pos media: ");
        for (int a = 0; a < linhaMO; a++) {
            for (int b = 0; b < colunaMO; b++) {
                System.out.printf("%d ", MOriginal[a][b]);
            }
            System.out.println("");
        }
        //Matriz pós media.
    ...
    public static void FiltroMediana(int Tamk, int matrix[][]) {
        ...
        for (int i = 0; i < linha; i++) {
            for (int j = 0; j < coluna; j++) {
                ...
                MOriginal[i+nAddBordas][j+nAddBordas] = mediana;  // Atualiza MO para calculo do proximo pixel.                
